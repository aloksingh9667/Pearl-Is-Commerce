...
export default function SignUpPage() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(212,175,55,0.12),_transparent_35%),linear-gradient(180deg,#FAF8F3_0%,#FFFDF8_100%)] flex items-center justify-center px-4 py-10 sm:py-14 lg:py-16">
      <div className="w-full max-w-6xl grid lg:grid-cols-[0.85fr_1.15fr] overflow-hidden rounded-[2rem] border border-[#D4AF37]/15 bg-white/55 shadow-[0_24px_100px_rgba(15,15,15,0.08)] backdrop-blur-2xl">
        <div className="hidden lg:flex flex-col justify-between p-10 xl:p-14 bg-[linear-gradient(180deg,rgba(212,175,55,0.96),rgba(155,118,22,0.98))] text-[#0F0F0F] relative">
          <div className="absolute inset-0 opacity-30 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.35),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(15,15,15,0.08),transparent_35%)]" />
          <div className="relative z-10">
            <Link href="/">
              <div className="inline-flex flex-col cursor-pointer">
                <div className="font-serif text-4xl tracking-[0.35em]">PEARLIS</div>
                <div className="text-[11px] tracking-[0.4em] uppercase text-[#0F0F0F]/80 mt-3">Join the private circle</div>
              </div>
            </Link>
            <div className="mt-16 max-w-md space-y-5">
              <h1 className="font-serif text-5xl leading-[1.05]">Create your account in seconds.</h1>
              <p className="text-[#0F0F0F]/75 text-base leading-7">
                Unlock saved favorites, faster checkout, and early access to new collections.
              </p>
            </div>
          </div>
          <div className="relative z-10 grid grid-cols-3 gap-4 text-sm text-[#0F0F0F]/75">
            <div className="rounded-2xl border border-[#0F0F0F]/10 bg-white/20 p-4">Luxury styling</div>
            <div className="rounded-2xl border border-[#0F0F0F]/10 bg-white/20 p-4">Google login</div>
            <div className="rounded-2xl border border-[#0F0F0F]/10 bg-white/20 p-4">Secure signup</div>
          </div>
        </div>
