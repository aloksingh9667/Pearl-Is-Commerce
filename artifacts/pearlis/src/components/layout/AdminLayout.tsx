...
import { 
  ...
  Settings, FileEdit, MessageSquare, Menu, X, ChevronDown, Video, Layers, Star
} from "lucide-react";
      ...
      <div className="flex-1 md:ml-64 flex flex-col min-h-screen">
        ...
        <main className="p-5 md:p-8 flex-1 bg-muted/10">
          <button
            ...
            className="inline-flex items-center gap-1 text-[9px] font-bold tracking-[0.22em] uppercase text-muted-foreground hover:text-accent transition-colors group mb-5"
          >
